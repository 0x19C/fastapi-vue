<template>
  <div class="fixed w-screen z-50 shadow top-0 left-0">
      ...
      <fwb-navbar>
        ...
        <template #default="{ isShowMenu }">
          <fwb-navbar-collapse v-if="isLoggedIn" :is-show-menu="isShowMenu">
            ...
            <fwb-navbar-link class="py-2" link="/dataset">
              Dataset
            </fwb-navbar-link>
            <fwb-navbar-link class="py-2" link="/model">
              Model
            </fwb-navbar-link>
            <fwb-navbar-link class="py-2" link="/training">
              Training
            </fwb-navbar-link>
